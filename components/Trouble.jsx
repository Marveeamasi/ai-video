...
const Trouble = ({z, handleCancel, handleRetry,heading='We’re having trouble generating your video ', message='A bug report has been submitted to our tech team, they’re looking into it - in the meantime, you can retry or create another project.'}) => {
  return (
    <div className={`bg-[#261148] w-full h-full top-0 fixed ${z}`}>
         ...
         <div className='font-[500] text-[32px] text-center'>{heading}</div>
         <div className='text-[#8C8C8C80] text-center text-[14px]'>{message}</div>
